...
2. check_stock → βρες τα διαθέσιμα προϊόντα στο κατάστημα
3. Συνδύασε τα αποτελέσματα: εξήγησε ΓΙΑΤΙ το προϊόν είναι συμβατό.
   Παράδειγμα απάντησης: "Το MacBook Air 2025 φορτίζει μέσω USB-C (30W–70W). Έχουμε τον [Προϊόν X] που υποστηρίζει USB-C — είναι συμβατός."
